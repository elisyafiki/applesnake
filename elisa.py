...
class Snake(GameObject):
    def __init__(self, position):
        super().__init__(pygame.Color(0, 255, 255), position)
    ...
    def draw(self, game_window):
        for pos in self.body:
            pygame.draw.rect(game_window, self.color, pygame.Rect(pos[0], pos[1], 25, 7))
...
class Game:
    def __init__(self):
        self.frame_size_x = 1080
        self.frame_size_y = 580
        self.game_window = pygame.display.set_mode((self.frame_size_x, self.frame_size_y))
        pygame.display.set_caption('Snake Game')
        self.fps_controller = pygame.time.Clock()
        self.snake = Snake([200, 50])
        self.apple1 = Apple(self.frame_size_x, self.frame_size_y, pygame.Color(0, 0, 0))
        self.apple2 = Apple(self.frame_size_x, self.frame_size_y, pygame.Color(255, 0, 0))
        self.score = 2

    def game_over(self):
        my_font = pygame.font.SysFont('Times New Roman', 90)
        game_over_surface = my_font.render('YAHHH GAGAL HAHAHA', True, pygame.Color(255, 255, 255))
